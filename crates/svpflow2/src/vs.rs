...
pub(crate) type GetCoreInfo = unsafe extern "system" fn(Raw) -> *const CoreInfo;
...
pub(crate) type PropGetFloat =
    unsafe extern "system" fn(ConstRaw, *const c_char, i32, *mut i32) -> f64;
...
pub(crate) type GetFramePropsRo = unsafe extern "system" fn(ConstRaw) -> ConstRaw;
pub(crate) type GetFramePropsRw = unsafe extern "system" fn(Raw) -> Raw;
...
pub(crate) const GET_CORE_INFO: usize = 16;
...
pub(crate) const GET_FRAME_PROPS_RO: usize = 344;
pub(crate) const GET_FRAME_PROPS_RW: usize = 352;
pub(crate) const GET_VIDEO_INFO: usize = 304;
pub(crate) const SET_VIDEO_INFO: usize = 312;
pub(crate) const PROP_GET_INT: usize = 392;
pub(crate) const PROP_GET_FLOAT: usize = 400;
...
pub(crate) unsafe fn free_nodes<const N: usize>(nodes: [Raw; N], vsapi: ConstRaw) {
